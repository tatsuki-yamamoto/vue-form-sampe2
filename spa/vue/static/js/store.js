var store = new Vuex.Store({
  ...
  mutations: {
    ...
    setDataName: function(state, payload) {
  ...
  actions: {
    appData: function(context) {

      alert('このタイミングでAPIを呼び出し、以下のJSONをサーバへ連携する\n'
         + '\n'
         + JSON.stringify(this.state.data, null, 4))

      // API呼び出し
      // return axios.post('./data/app.json', this.state.data) // 本当はPOST
      return axios.get('./data/app.json')
      .then(function (res) {
